...
/*
	A wrapper for the popup creation function
*/
...
function popup()
{
	...
	this.id = "";
	this.content_text = "";
	this.content_bgcolor = "lightgrey";
	this.content_text_color = "black";
	this.content_font_stylestring = "9pt sans-serif";
	this.title_text = "";
	this.title_bgcolor = "#0084d8";
	this.title_text_color = "lightgrey";
	this.border_color = "gray";
	this.scrollbar_color = "#00468c";
	this.shadow_color = "black";
	this.ShowOnStart = true;
	this.is_draggable = true;
	this.is_resizeable = true;
	this.show_old = false;
	this.is_external = false;
	this.disable_on_return = false;
	this.min_image = '../../image/min.gif';
	this.max_image = '../../image/max.gif';
	this.close_image = '../../image/close.gif';
	this.resize_image = '../../image/resize.gif';
}


popup.prototype.create = function()
{
	new popUp(this.left, this.top, this.width, this.height, this.id, this.content_text, this.content_bgcolor, this.content_text_color, this.content_font_stylestring, this.title_text, this.title_bgcolor, this.title_text_color, this.border_color, this.scrollbar_color, this.shadow_color, this.ShowOnStart, this.is_draggable, this.is_resizeable, this.show_old, this.is_external, this.disable_on_return, this.min_image, this.max_image, this.close_image, this.resize_image);
}
