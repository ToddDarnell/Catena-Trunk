...
class csgTransactionStatusType extends baseAdmin
{
	function __construct()
	{
		baseAdmin::__construct();
		$this->table_Name = "tblCSGTransactionStatusType";
	...
	*/
	function GetInstance()
	{
		...
		if(!isset($obj))
		{
			$obj = new csgTransactionStatusType();
		}
...
/*
	...
	-	return an id
		-1 if not valid
*/
function GetCSGStatusID($info)
{
	$oType = csgTransactionStatusType::GetInstance();
